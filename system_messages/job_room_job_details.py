"""
Embed builder for ``job_room_job_details`` system messages.

Sent to both parties when a job room is created, showing the
...
def build_embed(data: dict) -> tuple[discord.Embed, str, str]:
    """Construct a job-details embed for job room participants.
    ...
    body_parts = [
        f"> ***Details for the job linked to this job room.***",
        "",
